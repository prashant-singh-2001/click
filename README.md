...
3. **Launch** — hit **Launch**. Watch the per-action progress. This runs exactly what's in the
   editor, saved or not — a note appears if it ran edits you haven't saved yet.
